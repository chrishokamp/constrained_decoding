...
def constrained_decoding_endpoint():
    ...
    # WORKING: debug the `bitte` constraint, why doesn't this work?
...
def decode(source_lang, target_lang, source_sentence, constraints=None, n_best=1, length_factor=1.5, beam_size=5):
    ...
    print(u'Constraints: '.format(constraints))
    mapped_inputs = model.map_inputs(inputs)
    print(u'Mapped Inputs: '.format(mapped_inputs))
    ...
    if constraints is not None:
        ...
        print(u'input constraints: '.format(constraints))
