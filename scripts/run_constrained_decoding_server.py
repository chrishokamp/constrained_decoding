...
if __name__ == '__main__':
    ...
    src_data_processor = DataProcessor(lang=args.source_lang, use_subword=True, subword_codes=args.source_subword_codes)
    trg_data_processor = DataProcessor(lang=args.target_lang, use_subword=True, subword_codes=args.target_subword_codes)
